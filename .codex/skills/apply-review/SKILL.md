...
- **Project conventions**: respect `AGENTS.md`, `CLAUDE.md`, and existing repo guidance/code style when present. If a review item conflicts with a project rule, flag it and follow the rule.
