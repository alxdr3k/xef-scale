...
| AC-003 | REQ-003 | Given AI image parsing is enabled and consented, When an allowed image is uploaded, Then a processed file/session is created and the file parsing job creates pending review transactions. | automated TEST-003 | passing |
