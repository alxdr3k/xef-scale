...
| TEST-005 | Import repair, no-review completion, and undo/recovery flow | `test/controllers/transactions_controller_test.rb`, `test/controllers/import_issues_controller_test.rb`, `test/controllers/parsing_sessions_controller_test.rb`, `test/models/parsing_session_test.rb`, `test/jobs/ai_text_parsing_job_test.rb`, `test/jobs/file_parsing_job_test.rb`, `e2e/parsing_session.spec.ts`, `e2e/import_repair.spec.ts`, `e2e/import_undo.spec.ts`; legacy `test/controllers/reviews_controller_test.rb` and `test/integration/parsing_review_flow_test.rb` remain until review routes are removed | AC-005, AC-006 |
