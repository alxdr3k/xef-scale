...
| TRACE-003 | Q-001 | [ADR-0001](decisions/ADR-0001-auto-post-imports.md); expansion open | REQ-003 | AC-003 / TEST-003 | P1-M1 | REQ/INP | REQ-1B / INP-1B | REQ-1B.1, INP-1B.1, INP-1B.3 | Image upload complete rows auto-post to committed unless duplicate candidates; incomplete rows still use notes bridge until repair queue lands. |
