...
| `INP` | Input/parsing engines and institution coverage | `INP-1B` | `in_progress` | Text/image AI path exists; non-duplicate complete rows now auto-post; next work is duplicate policy and repair queue persistence. |
