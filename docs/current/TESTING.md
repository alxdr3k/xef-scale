...
# Rails test 서버 자동 기동 + Chromium 테스트 실행
bunx playwright test

# 3000 포트에 개발 서버가 떠 있으면 별도 포트 사용
PLAYWRIGHT_PORT=3010 bunx playwright test
```
...
- 시스템/E2E 테스트는 신규 사용자 플로우(특히 auto-post import, repair queue 해소, 중복 처리, 동의 게이트)에 추가.
