...
| [app/models/import_issue.rb](../../app/models/import_issue.rb) | 필수값 누락 import repair record — incomplete image row 저장 | implemented |
...
| [app/jobs/file_parsing_job.rb](../../app/jobs/file_parsing_job.rb) | 이미지 비동기 파싱 + incomplete row `ImportIssue` 저장/repair 알림 + 3단계 카테고리화 + 중복 감지 | implemented |
