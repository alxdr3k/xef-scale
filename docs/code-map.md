...
| [app/services/database_backup_service.rb](../app/services/database_backup_service.rb) | SQLite 백업 헬퍼 | needs audit (호출 위치 미확인) |
...
| Path | Reason |
|------|--------|
| [app/services/database_backup_service.rb](../app/services/database_backup_service.rb) | 호출 지점 미확인 — Rake 태스크/잡 어딘가에서 사용되는지 확인 필요 |
