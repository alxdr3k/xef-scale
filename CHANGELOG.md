...
## [0.4.0](https://github.com/alxdr3k/xef-scale/compare/0.3.2...0.4.0) (2026-05-21)
...
* **a11y:** add 'c' commit shortcut in review inbox (Phase 5 slice 4) ([#183](https://github.com/alxdr3k/xef-scale/issues/183)) ([4e44cf7](https://github.com/alxdr3k/xef-scale/commit/4e44cf7302bb590633e25c6b390405dec1ef1b05))
* **a11y:** global :focus-visible ring with semantic token (Phase 5 slice 2) ([#181](https://github.com/alxdr3k/xef-scale/issues/181)) ([1be20af](https://github.com/alxdr3k/xef-scale/commit/1be20af95eddd41363bfd4f3cea13b5aeb822687))
* **a11y:** keyboard 'd' shortcut to exclude current row (Phase 5 slice 6) ([#199](https://github.com/alxdr3k/xef-scale/issues/199)) ([12590fa](https://github.com/alxdr3k/xef-scale/commit/12590fab2bbab913e26a2fe481e62021d83dfe05))
* **a11y:** keyboard Enter shortcut to toggle row selection (Phase 5 slice 7) ([#200](https://github.com/alxdr3k/xef-scale/issues/200)) ([c92d6d6](https://github.com/alxdr3k/xef-scale/commit/c92d6d65f539345a55346fc56ca2fd713dfb8988))
* **a11y:** keyboard j/k row navigation in review inbox (Phase 5 slice 3) ([#182](https://github.com/alxdr3k/xef-scale/issues/182)) ([cfa0dd8](https://github.com/alxdr3k/xef-scale/commit/cfa0dd862bcf2ceaae946d9fb1b126c9e0d2165b))
* **a11y:** keyboard shortcuts help overlay '?' (Phase 5 slice 5) ([#184](https://github.com/alxdr3k/xef-scale/issues/184)) ([e74ff66](https://github.com/alxdr3k/xef-scale/commit/e74ff66c94df81f654d41dd6889d27018e058cc5))
* **a11y:** migrate allowances/duplicate_card/user_settings to tokens (Phase 5 slice 16) ([#212](https://github.com/alxdr3k/xef-scale/issues/212)) ([2424c95](https://github.com/alxdr3k/xef-scale/commit/2424c95af3ce51566efad08e9220eede60f59114))
* **a11y:** migrate dashboards + notifications + comments + devise/passwords (Phase 5 slice 20) ([#216](https://github.com/alxdr3k/xef-scale/issues/216)) ([452f250](https://github.com/alxdr3k/xef-scale/commit/452f25097a0ce3f12e95fa4dcec964638df9437c))
* **a11y:** migrate dashboards/calendar to semantic tokens (Phase 5 slice 11) ([#207](https://github.com/alxdr3k/xef-scale/issues/207)) ([ea1ed9f](https://github.com/alxdr3k/xef-scale/commit/ea1ed9f1874ea80cc1ded582677bab303be28c58))
* **a11y:** migrate dashboards/monthly + navbar to semantic tokens (Phase 5 slice 13) ([#209](https://github.com/alxdr3k/xef-scale/issues/209)) ([23d6ab7](https://github.com/alxdr3k/xef-scale/commit/23d6ab7064e5a861811d90e40ef4ce389fac47e1))
* **a11y:** migrate forms/slideover/devise to semantic tokens (Phase 5 slice 17) ([#213](https://github.com/alxdr3k/xef-scale/issues/213)) ([aa519d2](https://github.com/alxdr3k/xef-scale/commit/aa519d2d596fa9464b3cb0bdd4b71e6df74d79c7))
* **a11y:** migrate parsing_sessions partials to semantic tokens (Phase 5 slice 12) ([#208](https://github.com/alxdr3k/xef-scale/issues/208)) ([44aefbb](https://github.com/alxdr3k/xef-scale/commit/44aefbb0ea9cea5379b6a248c4341f2b5d0f67f6))
* **a11y:** migrate parsing_sessions/index to semantic tokens (Phase 5 slice 10) ([#204](https://github.com/alxdr3k/xef-scale/issues/204)) ([7dd47c8](https://github.com/alxdr3k/xef-scale/commit/7dd47c8b6584584ac9bf1c8dfa44f1aa74ae6304))
* **a11y:** migrate parsing_sessions/show + yearly to semantic tokens (Phase 5 slice 15) ([#211](https://github.com/alxdr3k/xef-scale/issues/211)) ([ceb5b47](https://github.com/alxdr3k/xef-scale/commit/ceb5b47bdbf5e5c7e853aa69e644db2676bdc61b))
* **a11y:** migrate reviews/show to semantic tokens (Phase 5 slice 9) ([#203](https://github.com/alxdr3k/xef-scale/issues/203)) ([d4ae22d](https://github.com/alxdr3k/xef-scale/commit/d4ae22d517620b6e0434dd3d98bef2e4916ac55c))
* **a11y:** migrate shared partials (panels/pickers/badges/flash) to semantic tokens (Phase 5 slice 19) ([#215](https://github.com/alxdr3k/xef-scale/issues/215)) ([21cfd88](https://github.com/alxdr3k/xef-scale/commit/21cfd8882cdfc618b1cea73668af86daed5b34c8))
* **a11y:** migrate transaction_cells + duplicate modals to semantic tokens (Phase 5 slice 18) ([#214](https://github.com/alxdr3k/xef-scale/issues/214)) ([ddfdf43](https://github.com/alxdr3k/xef-scale/commit/ddfdf434eae3b85058f4d2a7962c7cd01f22b3e1))
* **a11y:** migrate transactions/index to semantic tokens (Phase 5 slice 8) ([#202](https://github.com/alxdr3k/xef-scale/issues/202)) ([0ffab34](https://github.com/alxdr3k/xef-scale/commit/0ffab34844f93f67ccf21735598e0ff67fe53097))
* **a11y:** migrate transactions/reviews/mobile-nav + finalize Phase 5 audit (slice 22) ([#218](https://github.com/alxdr3k/xef-scale/issues/218)) ([2249c03](https://github.com/alxdr3k/xef-scale/commit/2249c03c7bd0112909025fd24358d4b42ec754a9))
* **a11y:** migrate workspaces + categories + memberships + mapping_row (Phase 5 slice 21) ([#217](https://github.com/alxdr3k/xef-scale/issues/217)) ([b64d91d](https://github.com/alxdr3k/xef-scale/commit/b64d91d7f0ae72bb6d012fd4d253442997388e74))
* **a11y:** migrate workspaces/settings + show to semantic tokens (Phase 5 slice 14) ([#210](https://github.com/alxdr3k/xef-scale/issues/210)) ([77b7100](https://github.com/alxdr3k/xef-scale/commit/77b7100c3f69c43a3c8714df6983a32a2414e8d0))
...
* **categories:** combine categories + 학습된 매핑 sections (Phase 3.4) ([#175](https://github.com/alxdr3k/xef-scale/issues/175)) ([d21728b](https://github.com/alxdr3k/xef-scale/commit/d21728b619f5ca41c611c95cbf704159dad9b755))
...
* **dashboard:** add RecurringPaymentCard (Phase 4 slice 3) ([#179](https://github.com/alxdr3k/xef-scale/issues/179)) ([c8f3825](https://github.com/alxdr3k/xef-scale/commit/c8f38257053c73294f670f54a0fc97a8e713dd91))
* **dashboard:** add VarianceCard (Phase 4 slice 2) ([#178](https://github.com/alxdr3k/xef-scale/issues/178)) ([c6c72a0](https://github.com/alxdr3k/xef-scale/commit/c6c72a035f5e0d1ac1ae5958070e04c90dc26552))
* **dashboard:** adopt _hero_stat + add ReviewInboxCard on monthly (Phase 4 slice 1) ([#177](https://github.com/alxdr3k/xef-scale/issues/177)) ([8039805](https://github.com/alxdr3k/xef-scale/commit/803980587e1b87f451f49da8e205c71fbcd7ef39))
...
* **i18n:** migrate all dashboards views to i18n (Phase 6-2) ([#226](https://github.com/alxdr3k/xef-scale/issues/226)) ([395521a](https://github.com/alxdr3k/xef-scale/commit/395521a01f61cf69d3b66c0dae4cd67abd89b931))
* **i18n:** migrate categories + category_mappings views to i18n (Phase 6-6) ([#231](https://github.com/alxdr3k/xef-scale/issues/231)) ([b03b9c6](https://github.com/alxdr3k/xef-scale/commit/b03b9c603b50415d4713b3fef497c3be5b64d71f))
* **i18n:** migrate controllers + helper + jobs to ko.yml (Phase 6 residual) ([#244](https://github.com/alxdr3k/xef-scale/issues/244)) ([8e13816](https://github.com/alxdr3k/xef-scale/commit/8e1381646d0f6e7abb22877371fedd5ad7efb88b))
* **i18n:** migrate JS Stimulus controllers to ko.yml (Phase 6 residual, JS side) ([#245](https://github.com/alxdr3k/xef-scale/issues/245)) ([c386b14](https://github.com/alxdr3k/xef-scale/commit/c386b145b194cd8a112ae009087abbc7ecbaa648))
* **i18n:** migrate parsing_sessions views to i18n (Phase 6-5) ([#229](https://github.com/alxdr3k/xef-scale/issues/229)) ([06a88c7](https://github.com/alxdr3k/xef-scale/commit/06a88c7e7b8cd102955dba93061ecd316f1974dd))
* **i18n:** migrate reviews views to i18n (Phase 6-4) ([#228](https://github.com/alxdr3k/xef-scale/issues/228)) ([eaaf2bc](https://github.com/alxdr3k/xef-scale/commit/eaaf2bc919525a7948166a668a925bcf0ff40a50))
* **i18n:** migrate shared partials + cells + comments + notifications + add contract test (Phase 6-9 — Phase 6 종료) ([#234](https://github.com/alxdr3k/xef-scale/issues/234)) ([d638b0f](https://github.com/alxdr3k/xef-scale/commit/d638b0f5c4e0373cd93a9b9a6166848183ddc91c))
* **i18n:** migrate transactions views to i18n (Phase 6-3) ([#227](https://github.com/alxdr3k/xef-scale/issues/227)) ([b7b8b39](https://github.com/alxdr3k/xef-scale/commit/b7b8b398dcd732ff446412b0c8fc5bee64ba85f2))
* **i18n:** migrate user_settings + allowances + devise + layouts to i18n (Phase 6-8a) ([#233](https://github.com/alxdr3k/xef-scale/issues/233)) ([61b8370](https://github.com/alxdr3k/xef-scale/commit/61b8370f218e9ce7f7460271df2d86a102fea6c3))
* **i18n:** migrate workspaces views + workspace_more + workspace_memberships/_invitations to i18n (Phase 6-7) ([#232](https://github.com/alxdr3k/xef-scale/issues/232)) ([e98dc1c](https://github.com/alxdr3k/xef-scale/commit/e98dc1c0fc14ed532a5b7cca3ec2b9ad73ac12cd))
* **i18n:** seed ko.yml with synthesis 8장 dictionary + migrate nav (Phase 6-1) ([#225](https://github.com/alxdr3k/xef-scale/issues/225)) ([39a31c8](https://github.com/alxdr3k/xef-scale/commit/39a31c8e2b769a1ba8de93cf2ed937bb0f9a1805))
...
* **import:** add ImportIssue data model (B1) ([#188](https://github.com/alxdr3k/xef-scale/issues/188)) ([658fbe4](https://github.com/alxdr3k/xef-scale/commit/658fbe49efbf75cb039189112110492bf2479fb4))
* **import:** add ImportIssue resolution flow (B4) ([#192](https://github.com/alxdr3k/xef-scale/issues/192)) ([01ead9d](https://github.com/alxdr3k/xef-scale/commit/01ead9da03d21f2df096a5ff01da8d1100f3d3a2))
* **import:** divert incomplete parsed rows to ImportIssue (B2) ([#190](https://github.com/alxdr3k/xef-scale/issues/190)) ([a6a3439](https://github.com/alxdr3k/xef-scale/commit/a6a3439a9e62427430bdb930cd605c13928eee67))
* **import:** surface open ImportIssue count on review/import surfaces (B3) ([#191](https://github.com/alxdr3k/xef-scale/issues/191)) ([de4f102](https://github.com/alxdr3k/xef-scale/commit/de4f10217bbaf08814725d1f4cb48d35b3140054))
* **jobs:** add ActiveStorageBlobCleanupJob with daily recurring schedule (ADR-0002 A2) ([#154](https://github.com/alxdr3k/xef-scale/issues/154)) ([bbabf10](https://github.com/alxdr3k/xef-scale/commit/bbabf1047d032ec8b8765d44a3b1a12728e5ff22))
...
* **metrics:** add import_review_metrics:report rake task ([#187](https://github.com/alxdr3k/xef-scale/issues/187) baseline) ([#194](https://github.com/alxdr3k/xef-scale/issues/194)) ([db91bb0](https://github.com/alxdr3k/xef-scale/commit/db91bb0fba23099b2cfe6cbc8c723f60695e02c0))
* **metrics:** add ImportReviewEvent logging for [#187](https://github.com/alxdr3k/xef-scale/issues/187) baseline ([#189](https://github.com/alxdr3k/xef-scale/issues/189)) ([c5a4604](https://github.com/alxdr3k/xef-scale/commit/c5a46040169973cdf6a1ceeec4d43825096cec9a))
* **metrics:** add web admin metrics dashboard (Phase 7-1) ([#236](https://github.com/alxdr3k/xef-scale/issues/236)) ([0399314](https://github.com/alxdr3k/xef-scale/commit/03993141950395c2911cdf72767f3f9c8e35c0fe))
* **metrics:** classification_source distribution + AI 수용률 proxy (Phase 7-3) ([#238](https://github.com/alxdr3k/xef-scale/issues/238)) ([ebb4dc5](https://github.com/alxdr3k/xef-scale/commit/ebb4dc5bc151e52cb7a988b7c31e792f1b7e82e6))
* **metrics:** CSV export for external analysis tools (Phase 7-4 — Phase 7 종료) ([#239](https://github.com/alxdr3k/xef-scale/issues/239)) ([7a51159](https://github.com/alxdr3k/xef-scale/commit/7a511595f0777d5286bfa46ec54aadf7c8cb58fa))
* **metrics:** HTML card formatting for metrics dashboard (Phase 7-2) ([#237](https://github.com/alxdr3k/xef-scale/issues/237)) ([3b271d4](https://github.com/alxdr3k/xef-scale/commit/3b271d464cf5c30616f881a5f73455ba8f42cc6c))
* **more:** add 더보기 dedicated page (Phase 3.5) ([#176](https://github.com/alxdr3k/xef-scale/issues/176)) ([b53fd05](https://github.com/alxdr3k/xef-scale/commit/b53fd05e54fc578d55e54bde340816cfad9b4d92))
...
* **processed_files:** add blob_purged_at column and retention helpers (ADR-0002 A1) ([#153](https://github.com/alxdr3k/xef-scale/issues/153)) ([ac77766](https://github.com/alxdr3k/xef-scale/commit/ac777665aaf826f3cf712e1fe30b56242bfd39f3))
...
* **reviews:** add review inbox index + 5-tab IA (ADR-0004, PR B) ([#170](https://github.com/alxdr3k/xef-scale/issues/170)) ([3d3eccb](https://github.com/alxdr3k/xef-scale/commit/3d3eccbef8d6911666af772dec1f47f0952f3a10))
...
* **reviews:** move 3-way input form into "+ 새로 가져오기" sheet (Phase 3.3) ([#173](https://github.com/alxdr3k/xef-scale/issues/173)) ([e6a3668](https://github.com/alxdr3k/xef-scale/commit/e6a366817cfd8369706e27d1e05091b487100f4c))
...
* **theme:** add User#theme + dark mode toggle (Phase 5 slice 1) ([#180](https://github.com/alxdr3k/xef-scale/issues/180)) ([b6a6050](https://github.com/alxdr3k/xef-scale/commit/b6a605048718a6fcdafda97c86e0f800ced294d9))
...
* **transactions:** add classification_source column (ADR-0011) ([#169](https://github.com/alxdr3k/xef-scale/issues/169)) ([4c5e8f6](https://github.com/alxdr3k/xef-scale/commit/4c5e8f61db4f123ae0deb76b79f8cd3dca4d2b3d))
...
* **transactions:** set classification_source at call sites (Phase 3.2) ([#174](https://github.com/alxdr3k/xef-scale/issues/174)) ([0bb6b50](https://github.com/alxdr3k/xef-scale/commit/0bb6b5061a9cf5c23d676956e2d30684c6fed179))
* **ui:** add atomic partials _source_icon, _pending_badge, _category_source_chip ([#160](https://github.com/alxdr3k/xef-scale/issues/160)) ([329a9d3](https://github.com/alxdr3k/xef-scale/commit/329a9d3150b98196b33103cff69781c1d5f0bcb4))
...
* **ui:** add shared/_inline_alert partial ([#165](https://github.com/alxdr3k/xef-scale/issues/165)) ([b917aba](https://github.com/alxdr3k/xef-scale/commit/b917aba09db09b8a31a3487b55c82cb50fc73c03))
...
* **ui:** adopt _category_source_chip in category_cell ([#164](https://github.com/alxdr3k/xef-scale/issues/164)) ([8b2ea21](https://github.com/alxdr3k/xef-scale/commit/8b2ea216aa869f90be693f221dee903bddcbf93c))
* **ui:** adopt _inline_alert for AI consent notice in parsing_sessions/index ([#166](https://github.com/alxdr3k/xef-scale/issues/166)) ([4092f93](https://github.com/alxdr3k/xef-scale/commit/4092f933afcd5075c1417b32b9e95f3ae8f47085))
* **ui:** adopt _pending_badge in merchant_cell ([#162](https://github.com/alxdr3k/xef-scale/issues/162)) ([5835768](https://github.com/alxdr3k/xef-scale/commit/5835768ffb05e3bfbfe381719d2767a8514466e5))
* **ui:** adopt _source_icon in source_metadata_cell popover trigger ([#163](https://github.com/alxdr3k/xef-scale/issues/163)) ([4a6fce3](https://github.com/alxdr3k/xef-scale/commit/4a6fce3b45b9bc7088ed308793a3a6687d70da0e))
* **ui:** adopt [@theme](https://github.com/theme) tokens and self-host Pretendard (dynamic-subset, ADR-0010) ([#158](https://github.com/alxdr3k/xef-scale/issues/158)) ([f156d10](https://github.com/alxdr3k/xef-scale/commit/f156d101021bc6dffa217ed05cb3d72c09e2da5a))
...
* **ui:** extract core shared partials and migrate application shell to bg-page ([#159](https://github.com/alxdr3k/xef-scale/issues/159)) ([1c21721](https://github.com/alxdr3k/xef-scale/commit/1c2172140c121c8e6063f0656b1b3f715ee3a093))
...
* **ui:** replace silent category mapping with explicit opt-in learning (ADR-0007 §4) ([#167](https://github.com/alxdr3k/xef-scale/issues/167)) ([3b4de49](https://github.com/alxdr3k/xef-scale/commit/3b4de499b6c5c1bf92a90c8a235576f924f5c43e))
* **ui:** show '원본 만료' badge for purged ProcessedFile blobs (ADR-0002 A3) ([#155](https://github.com/alxdr3k/xef-scale/issues/155)) ([b44f75b](https://github.com/alxdr3k/xef-scale/commit/b44f75b261ca5376ae774209064327ab1026f2d1))
...
* **a11y,tokens:** close navbar focus regression + black/white token blind spot ([#247](https://github.com/alxdr3k/xef-scale/issues/247)) ([716ea09](https://github.com/alxdr3k/xef-scale/commit/716ea09bc8a70a03940871c050bebe5f41046d08))
* **a11y:** focus trap and restore on input sheet dialog ([#197](https://github.com/alxdr3k/xef-scale/issues/197)) ([f838257](https://github.com/alxdr3k/xef-scale/commit/f838257bdc203117180df0af5fdb0ccfbeb2f867))
* **a11y:** migrate 3 modal Stimulus controllers' dynamic DOM to semantic tokens (Phase 5 cleanup, Scope C-3) ([#223](https://github.com/alxdr3k/xef-scale/issues/223)) ([0bc6f4e](https://github.com/alxdr3k/xef-scale/commit/0bc6f4ea48ffb1bff146fd2bfbe3091e3146fb33))
* **a11y:** migrate 7 Stimulus controllers' dynamic DOM to semantic tokens (Phase 5 cleanup C-2) ([#222](https://github.com/alxdr3k/xef-scale/issues/222)) ([79be17c](https://github.com/alxdr3k/xef-scale/commit/79be17c948b70d1f242b3cfe030240ead73f5017))
* **a11y:** migrate CSS / helper / category_cell ring to semantic tokens (Phase 5 cleanup, Scope C-1) ([#221](https://github.com/alxdr3k/xef-scale/issues/221)) ([842c425](https://github.com/alxdr3k/xef-scale/commit/842c425016b5b076c520e6a77666483bb7f0a35a))
...
* **dashboard:** exclude refunds and coupons from recurring detector ([#198](https://github.com/alxdr3k/xef-scale/issues/198)) ([0ab1726](https://github.com/alxdr3k/xef-scale/commit/0ab17262a61d4b39dac487426a24fbd64b1d300f))
...
* **i18n,metrics:** address adversarial review findings on PR [#232](https://github.com/alxdr3k/xef-scale/issues/232)–[#239](https://github.com/alxdr3k/xef-scale/issues/239) ([#241](https://github.com/alxdr3k/xef-scale/issues/241)) ([942932f](https://github.com/alxdr3k/xef-scale/commit/942932f46a9df830c344f76da94db115e3d65119))
...
* **metrics,dashboards:** address GPT adversarial review findings on PR [#240](https://github.com/alxdr3k/xef-scale/issues/240)-[#248](https://github.com/alxdr3k/xef-scale/issues/248) ([#249](https://github.com/alxdr3k/xef-scale/issues/249)) ([9e9c28e](https://github.com/alxdr3k/xef-scale/commit/9e9c28e9e7d52a760716f09fcd5f9d8483e05fa3))
...
* **provenance:** apply MerchantRematchPolicy to ledger full edit + permit :description (Phase 5 cleanup, Scope A) ([#219](https://github.com/alxdr3k/xef-scale/issues/219)) ([80bb56d](https://github.com/alxdr3k/xef-scale/commit/80bb56d68af7f5cae441d52fcf16207b8b4b99f1))
...
* **reviews,home:** commit_locked UI gate + calendar quick filter retarget ([#248](https://github.com/alxdr3k/xef-scale/issues/248)) ([c0b6518](https://github.com/alxdr3k/xef-scale/commit/c0b651881316ebc4b58ca29bcdd0ea74f8c37c34))
...
* **reviews:** preserve review edit context and enforce read-only member UI (Hotfix A) ([#195](https://github.com/alxdr3k/xef-scale/issues/195)) ([6e8744f](https://github.com/alxdr3k/xef-scale/commit/6e8744f3831175b44e04afb433c27a1c3cc3bd3b))
...
* **security:** close slideover review-context guard at finalized sessions (Phase 5 cleanup, Scope B) ([#220](https://github.com/alxdr3k/xef-scale/issues/220)) ([9f09cff](https://github.com/alxdr3k/xef-scale/commit/9f09cffa66f439fb77c718f10f98dad303c19fe0))
...
* **transactions:** repair classification_source semantics and bulk validation ([#196](https://github.com/alxdr3k/xef-scale/issues/196)) ([a152a16](https://github.com/alxdr3k/xef-scale/commit/a152a16c14fba6feef8db27c0f5229ca487cb9b7))
...
* **ui:** harden category learning suggestion accept against stale snapshots ([#171](https://github.com/alxdr3k/xef-scale/issues/171)) ([226c57b](https://github.com/alxdr3k/xef-scale/commit/226c57bc6e41fe86546e8ae063c1a2e3dd799c48))
